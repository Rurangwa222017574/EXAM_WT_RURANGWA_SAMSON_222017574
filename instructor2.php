...
<button type="button" class="btn btn-primary " data-bs-toggle="modal" data-bs-target="#exampleModal" data-bs-whatever="@fat">Add Instructor</button>
  ...
  <div class="modal-dialog">
    ...
    <section id="courseSubmission">
        ...
        <table class="table table-striped table-hover table-bordered">
            ...
            $sql = "SELECT * FROM instructor INNER JOIN course ON instructor.course_id=course.course_id";
            ...
            if (mysqli_num_rows($result)> 0) {
                while ($row =mysqli_fetch_array($result)) {
                    ...
                    <tr>
                        ...
                        <td><a href="update instructor.php?id=<?php echo $row["instructor_id"]; ?>" class="btn btn-primary ">Update</a></td>
                        <td><a href="delete instructor.php?id=<?php echo $row["instructor_id"]; ?>" class="btn btn-danger ">Delete</a></td>
