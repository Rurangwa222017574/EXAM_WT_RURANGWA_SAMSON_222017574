...
if (isset($_POST['submit'])) {
    ...
    $insert = mysqli_query($con, "INSERT INTO feedback (workshop_id, attendee_id, rating, comment, created_at) VALUES ('$workshop_id', '$attendee_id', '$rating', '$comment', '$date')");
    
    if ($insert) {
        // Redirect to feedback confirmation page or any other desired page
    ...
    <div class="container">
        <div class="row mt-5 pt-4">
            ...
            <div class="col-md-6 mb-5">
                <h3 class="text-center mb-4">Feedback Submission</h3>
                <div class="card shadow mb-5 bg-white">
                    <div class="card-body">
                        <div class="card-title mb-4"><h5>Feedback Form</h5></div>
                        <!-- Feedback Submission Form -->
                        <form id="feedbackForm" action="feedback.php" method="post">
                            <label for="workshop_id">Workshop ID:</label>
                            <input type="text" id="workshop_id" name="workshop_id" class="form-control mb-2 shadow" placeholder="Workshop ID" required>

                            <label for="rating">Rating:</label>
                            <input type="number" id="rating" name="rating" class="form-control mb-2 shadow" placeholder="Rating (1-5)" min="1" max="5" required>

                            <label for="comment">Comment:</label>
                            <textarea id="comment" name="comment" class="form-control mb-2 shadow" placeholder="Your comment here" required></textarea>

                            <button type="submit" name="submit" class="form-control btn btn-primary mb-2 m-2 shadow">Submit</button>
                        </form>
                    </div>
                </div>
            </div>
        ...
        <div class="row pt-4">
            ...
            <div class="col-md-4">
                ...
                <div id="detail" class="mb-3 ps-3">
                    <a href="" class="d-block">&rarr; course</a>
